...
The input consists of one string  containing lower case English letters (). This is the message sent by grandma. It is guaranteed that this string is the result of a word being written three times, where possibly one letter was changed to some other letter.

Output

Output one string , the original word.
